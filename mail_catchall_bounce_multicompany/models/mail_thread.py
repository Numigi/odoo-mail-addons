...
class MailThread(models.AbstractModel):
    ...
    def message_route(self, message, message_dict, model=None, thread_id=None, custom_values=None):
        ...
        bounce_alias_static = tools.str2bool(
            self.env['ir.config_parameter'].sudo().get_param("mail.bounce.alias.static", "False"))
        ...
        if rcpt_tos_localparts:
            ...
            if catchall_alias and email_to_localparts and all(
                ...
                try:
                    ...
                    _logger.warning("Mail Bounce Fix: Failed to determine company from domain: %s", e)
                ...
                reply_to_email = target_company.email or self.env.company.email
                # --- END NUMIGI PATCH ---
