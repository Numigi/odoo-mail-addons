...
class TestMailAutosubscribe(SavepointCase):
    ...
    def test_mail_template(self):
        ...
        mail_id = self.mail_template.send_mail(self.order.id)
        mail = self.env["mail.mail"].browse(mail_id)
        self.assertEqual(mail.recipient_ids, self.partner_2 | self.partner_3)
    ...
    def test_mail_message_composer(self):
        ...
        self.assertEqual(composer.partner_ids, self.partner_2 | self.partner_3)
    ...
    def test_mail_message_composer_no_autosubscribe_followers(self):
        ...
        self.assertEqual(composer.partner_ids, self.partner_2)
